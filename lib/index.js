...
var toFrontMatter = function (data) {
    return "---\n" + yaml.stringify(data) + "\n---\n";
};
...
var saveFile = function (frontMatter, type, languageField) { return __awaiter(void 0, void 0, void 0, function () {
    var notionId, lang, title, slug, mdblocks, imageBlocks, images, imagePath, _i, imageBlocks_1, block, data, url, urlPathname, newName, extension, name_1, filename, src, file, mdBody, _a, images_1, image, newFile;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                mdblocks = _c.sent();
                imageBlocks = mdblocks
                    .filter(function (block) { return block.type === "image"; })
                    .map(function (block) { return block.parent; });
                images = [];
            ...
            case 2:
                ...
                newName = urlPathname.split("/");
                extension = data[0].substring(data[0].lastIndexOf("."));
                name_1 = (_b = "".concat(newName[newName.length - 2]).concat(extension)) !== null && _b !== void 0 ? _b : data[0];
